...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'partner-list': RouteRecordInfo<'partner-list', '/partner/list', Record<never, never>, Record<never, never>>,
    'partner-list-add-new-partner-drawer': RouteRecordInfo<'partner-list-add-new-partner-drawer', '/partner/list/AddNewPartnerDrawer', Record<never, never>, Record<never, never>>,
